...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->string('ar_name'); // For MySQL 8.0 use string('guard_name', 125);
            $table->string('routes'); // For MySQL 8.0 use string('guard_name', 125);
            $table->string('guard_name'); // For MySQL 8.0 use string('guard_name', 125);
            $table->timestamps();

            $table->unique(['name', 'guard_name', 'ar_name']);
        });
