...
class CreateForeignKeys extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('articale_client', function (Blueprint $table) {
            $table->foreign('client_id')->references('id')->on('clients')
                ->onDelete('cascade')
                ->onUpdate('cascade');
        });
    ...
    public function down()
    {
        ...
        Schema::table('articales', function (Blueprint $table) {
            $table->dropForeign('articales_category_id_foreign');
        });
        Schema::table('articale_client', function (Blueprint $table) {
            $table->dropForeign('articale_client_client_id_foreign');
        });
        Schema::table('articale_client', function (Blueprint $table) {
            $table->dropForeign('articale_client_articale_id_foreign');
        });
        Schema::table('donation_requests', function (Blueprint $table) {
