...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">قائمة المحافظات</h4>
            </div>
            <div class="col-sm-6">
                        ...
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <tbody>
                                @foreach ($governorates as $governorate)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#edit{{ $governorate->id }}" title="تعديل"><i
                                                    class="fa fa-edit"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#delete{{ $governorate->id }}" title="حذف"><i
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('governorates.update', $governorate->id) }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <label for="name" class="mr-sm-2">اسم المحافظه
                                                                    :</label>
                                                                <input id="name" type="text" name="name"
                                                                    class="form-control" value="{{ $governorate->name }}"
                                                                    required>
                                                                <input id="id" type="hidden" name="id"
                                                                    class="form-control" value="{{ $governorate->id }}">
                                                            </div>
                                                        </div>
                                    ...
                                    <!-- delete_modal_Grade -->
                                    <div class="modal fade" id="delete{{ $governorate->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('governorates.destroy', $governorate->id) }}"
                                                        ...
                                                        @method('Delete')
                                                        @csrf
                                                        هل انت متاكد من عملية حذف المحافظه؟
                                                        <br>
                                                        <input id="id" type="hidden" name="id"
                                                            class="form-control" value="{{ $governorate->id }}">
