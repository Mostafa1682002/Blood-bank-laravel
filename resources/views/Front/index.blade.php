        ...
        <div class="container">
            <div class="col-md-7">
                ...
                <div class="row whatsapp">
                    <a href="#">
                        <img src="{{ asset('assets/front/imgs/whats.png') }}">
        ...
        <div class="container">
            <div class="row">
                <div class="info col-md-6">
                    ...
                    <div class="download">
                        ...
                        <div class="row stores">
                            <div class="col-sm-6">
                                <a href="#">
                                    <img src="{{ asset('assets/front/imgs/google.png') }}">
                                </a>
                            </div>
                            <div class="col-sm-6">
                                <a href="#">
                                    <img src="{{ asset('assets/front/imgs/ios.png') }}">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="screens col-md-6">
                    <img src="{{ asset('assets/front/imgs/App.png') }}">
                </div>
            </div>
        </div>
    </div>
