                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('settings.update') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">عن التطبيق</label>
                            <textarea class="form-control" name="about_app" id="exampleFormControlTextarea1" rows="4">{{ $setting->about_app }}</textarea>
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">الاشعارات</label>
                            <textarea class="form-control" name="notification_setting_text" id="exampleFormControlTextarea1" rows="4">{{ $setting->notification_setting_text }}</textarea>
                        </div>
                        <br>
