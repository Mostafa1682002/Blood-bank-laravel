                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="{{ route('governorates.index') }}"><i class="ti-menu-alt"></i><span
                                class="right-nav-text">المحافظات
                            </span> </a>
                    </li>
                    <!-- menu item Cities-->
                    <li>
                        <a href="{{ route('cities.index') }}"><i class="ti-location-pin"></i><span
                                class="right-nav-text">المدن
                            </span> </a>
                    </li>
                    <!-- menu item Categories-->
                    <li>
                        <a href="{{ route('categories.index') }}"><i class="ti-file"></i><span
                                class="right-nav-text">الاقسام
                            </span> </a>
                    </li>
                    <!-- menu item Articales-->
                    <li>
                        <a href="{{ route('articles.index') }}"><i class="ti-comments"></i><span
                                class="right-nav-text">المقالات</span></a>
                    </li>
                    <!-- menu item Clients-->
                    <li>
                        <a href="{{ route('clients.index') }}"><i class="fas fa-users"></i><span
                                class="right-nav-text">العملاء</span></a>
                    </li>
                    <!-- menu item calendar-->
                    <li>
